    ...
    <aside class="setting__nav">
      ...
      <div class="setting__nav-list">
        ...
        <template v-if="user.hasSubscription">
          <span class="setting__nav-pointer"></span>
          <a @click="scrollMeTo('handle')" :class="{'is-active' : sectionActive == 'handle'}" class="setting__nav-text">Handle</a>
        </template>
        <span class="setting__nav-pointer"></span>
        <a @click="scrollMeTo('redeem')" :class="{'is-active' : sectionActive == 'redeem'}" class="setting__nav-text">Redeem</a>
      </div>
    </aside>
  </div>
</template>
