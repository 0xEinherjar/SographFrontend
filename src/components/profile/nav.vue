...
watch(
  ...
  async (_) => {
    document.querySelectorAll(".profile__nav-link").forEach((link) => {
      link.classList.remove("is-active");
      if (link.dataset.nav === "Publications") link.classList.add("is-active");
    });
...
<template>
  <div class="u-flex-line-between">
    <nav class="profile__nav-group u-flex-line">
      <a class="profile__nav-link is-active" data-nav="Publications" @click="profileNav">Publications</a>
      <a class="profile__nav-link" data-nav="Followers" @click="profileNav">Followers</a>
      <a class="profile__nav-link" data-nav="Following" @click="profileNav">Following</a>
      <a class="profile__nav-link" data-nav="About" @click="profileNav">About</a>
    </nav>
    <ul class="profile__nav-actions u-flex-line">
      <li class="profile__nav-item dropdown">
        <button>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.9902 17.5H16.5002C19.5202 17.5 22.0002 15.03 22.0002 12C22.0002 8.98 19.5302 6.5 16.5002 6.5H14.9902" stroke="#F4F4F4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 6.5H7.5C4.47 6.5 2 8.97 2 12C2 15.02 4.47 17.5 7.5 17.5H9" stroke="#F4F4F4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="dropdown__group">
          <ul class="dropdown__menu">
            ...
            <li v-if="links?.youtube" class="dropdown__item">
              ...
              <!-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 15L15.19 12L10 9V15ZM21.56 7.17C21.69 7.64 21.78 8.27 21.84 9.07C21.91 9.87 21.94 10.56 21.94 11.16L22 12C22 14.19 21.84 15.8 21.56 16.83C21.31 17.73 20.73 18.31 19.83 18.56C19.36 18.69 18.5 18.78 17.18 18.84C15.88 18.91 14.69 18.94 13.59 18.94L12 19C7.81 19 5.2 18.84 4.17 18.56C3.27 18.31 2.69 17.73 2.44 16.83C2.31 16.36 2.22 15.73 2.16 14.93C2.09 14.13 2.06 13.44 2.06 12.84L2 12C2 9.81 2.16 8.2 2.44 7.17C2.69 6.27 3.27 5.69 4.17 5.44C4.64 5.31 5.5 5.22 6.82 5.16C8.12 5.09 9.31 5.06 10.41 5.06L12 5C16.19 5 18.8 5.16 19.83 5.44C20.73 5.69 21.31 6.27 21.56 7.17Z" fill="#BDC1C6"/>
              </svg> -->
